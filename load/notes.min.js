...
function ajax_request(task,post,callback){$.post("https://notes.5d7.eu/ajax.php?"+task,post,function(data){if(typeof data==="object"){if(data.status==='error'){console.log(data.error)}
